...
public class FXMLLoader {
    ...
    private class IncludeElement extends ValueElement {
        ...
        public Object constructValue() throws IOException {
            ...
            FXMLLoader.this.childrenLoaders.add(fxmlLoader);
    ...
    private List<FXMLLoader> childrenLoaders;

    public List<FXMLLoader> getChildrenLoaders(){
        return childrenLoaders;
    }
    ...
    public FXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
        ...
        this.childrenLoaders = new ArrayList<>();
    }
